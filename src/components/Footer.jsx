            ...
            <div className="container-fluid p-0">
                <div className="row justify-content-center px-5 pt-5">
                    ...
                    <div className="col-md-3 px-5">
                        ...
                        <ul className="list-unstyled">
                            <li><a href="#" className="text-decoration-none text-dark">Fresh food</a></li> {/*lien de page à voir une fois créé */}
                            <li><a href="#" className="text-decoration-none text-dark">Restaurant Akira</a></li> {/*lien de page à voir une fois créé */}
                            <li><a href="#" className="text-decoration-none text-dark">Espace bien-être</a></li> {/*lien de page à voir une fois créé */}
                        </ul>
                    </div>
                    ...
                    <div className="col-md-3 px-5">
                        ...
                        <ul className="list-unstyled">
                            <li><a href="#" className="text-decoration-none text-dark">Coder son site en HTML/CSS</a></li> {/*lien de page à voir une fois créé */}
                            <li><a href="#" className="text-decoration-none text-dark">Vendre ses produits sur le web</a></li> {/*lien de page à voir une fois créé */}
                            <li><a href="#" className="text-decoration-none text-dark">Se positionner sur Google</a></li> {/*lien de page à voir une fois créé */}
                        </ul>
                    </div>
                </div>
                <button
