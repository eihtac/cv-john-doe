                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordion">
                        <div className="accordion-body">
                            ...
                            <a href="tel:+33620304050" className="text-decoration-none mb-1 d-block">
                                <FontAwesomeIcon icon={faMobileScreenButton} style={{ color: "#444444" }} /> 06 20 30 40 50
                            </a>
                            <a href="mailto:john.doe@gmail.com" className="text-decoration-none d-block">
                                <FontAwesomeIcon icon={faEnvelope} style={{ color: "#444444" }} /> john.doe@gmail.com
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordion">
                        <div className="accordion-body">
                            ...
                            <a href="https://www.alwaysdata.com" className="text-decoration-none">
                                <FontAwesomeIcon icon={faGlobe} style={{ color: "#444444" }} /> www.alwaysdata.com
                            </a>
                        </div>
                    </div>
                </div>
