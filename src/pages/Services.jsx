    ...
    return (
        <div className="services d-flex justify-content-center align-items-center flex-column mb-5">
            ...
            <div className="container mt-5">
                <div className="row">
                    <div className="col-md-4 col-12 mb-1 pb-5">
                        <div className="card text-center shadow-sm py-5 px-3 h-100 d-flex flex-column">
                            <FontAwesomeIcon icon={faDisplay} size="3x" className="text-primary my-4 service-icon" />
                    ...
                    <div className="col-md-4 col-12 mb-1 pb-5">
                        <div className="card text-center shadow-sm py-5 px-3 h-100 d-flex flex-column">
                            <FontAwesomeIcon icon={faFileCode} size="3x" className="text-primary my-4 service-icon" />
                    ...
                    <div className="col-md-4 col-12 mb-1 pb-5">
                        <div className="card text-center shadow-sm py-5 px-3 h-100 d-flex flex-column">
                            <FontAwesomeIcon icon={faMagnifyingGlassDollar} size="3x" className="text-primary my-4 service-icon" />
